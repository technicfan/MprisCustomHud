...
| `mpris_progress` | Special | progress in MM:SS format, number of seconds, progress > 0              |
| `mpris_duration` | Special | duration of the track in MM:SS format, number of seconds, duration > 0 |
